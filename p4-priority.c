...
testPromotion(void)
{
  ...
  printf(1, "testPromotion about to return\n");
  return;
}
...
checkPriority(void)
{
  ...
  printf(1, "Testing that a priority cannot be set to an out of range value (i.e a negative number).\n");
